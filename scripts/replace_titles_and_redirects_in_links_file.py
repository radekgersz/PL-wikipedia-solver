...
ALL_PAGE_IDS = set()
PAGE_TITLES_TO_IDS = {}
with gzip.open(PAGES_FILE, mode="rt", encoding="utf-8") as f:
  for line in f:
...
REDIRECTS = {}
with gzip.open(REDIRECTS_FILE, mode="rt", encoding="utf-8") as f:
  for line in f:
...
with gzip.open(LINKS_FILE, mode="rt", encoding="utf-8") as f:
  for line in f:
